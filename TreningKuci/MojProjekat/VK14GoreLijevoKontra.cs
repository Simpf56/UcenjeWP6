...
{
    internal class VK14GoreLijevoKontra
    {
        public static void VjezbaKuci()
        {
            Console.WriteLine("VK14");
            //int redovi = 3;
            //int stupci = 3;

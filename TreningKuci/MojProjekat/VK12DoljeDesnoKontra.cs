...
{
    internal class VK12DoljeDesnoKontra
    {
        public static void VjezbaKuci()
        {
            Console.WriteLine("VK12");
            //int redovi = 3;
            //int stupci = 3;

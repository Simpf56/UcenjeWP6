...
{
    internal class VK15DoljeLijevoKontra
    {
        public static void VjezbaKuci()
        {
            Console.WriteLine("VK15");
            //int redovi = 3;
            //int stupci = 3;
